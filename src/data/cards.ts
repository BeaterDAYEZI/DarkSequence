...
const warwickCards: CardDef[] = [
  ...
  ...mkCards('warwick', 'warwick_wall', '壁垒之盾', [
    ...
    { rarity: 'green', cost: 2, tags: ['defense', 'heal'], effects: [{ kind: 'block', target: SELF, amount: 10 }, { kind: 'heal', target: SELF, amount: 2 }] },
  ...
  ...mkCards('warwick', 'warwick_hammer', '蚀铁锤击', [
    ...
    { rarity: 'green', cost: 2, tags: ['attack', 'speed'], effects: [{ kind: 'damage', target: EPOS([1]), amount: [6, 8] }, { kind: 'applyStatus', target: EPOS([1]), status: 'vulnerable', stacks: 1, duration: -1, condition: 'speedGE2' }] },
  ...
  ...mkCards('warwick', 'warwick_taunt', '嘲讽咆哮', [
    ...
    { rarity: 'green', cost: 1, tags: ['madness', 'soulfire'], effects: [{ kind: 'taunt', duration: 2, value: 1 }] },
  ...
  ...mkCards('warwick', 'warwick_charge', '列车冲锋', [
    ...
    { rarity: 'green', cost: 2, tags: ['speed'], effects: [{ kind: 'speed', amount: 2 }, { kind: 'damage', target: EPOS([1]), amount: 5 }, { kind: 'block', target: SELF, amount: 2 }] },
  ...
  ...mkCards('warwick', 'warwick_gasp', '残喘之躯', [
    ...
    { rarity: 'green', cost: 1, tags: ['defense'], effects: [{ kind: 'damage', target: SELF, amount: 2, pierceBlock: true }, { kind: 'block', target: SELF, amount: 13 }, { kind: 'clearStatus', target: SELF, stacks: 1 }] },
...
const morganCards: CardDef[] = [
  ...
  ...mkCards('morgan', 'morgan_decapitate', '断首斩', [
    ...
    { rarity: 'green', cost: 2, tags: ['attack'], effects: [{ kind: 'damage', target: EPOS([1, 2]), amount: [8, 11], hpBelow50Bonus: 0.3 }] },
  ...
  ...mkCards('morgan', 'morgan_fury', '血腥狂怒', [
    ...
    { rarity: 'green', cost: 2, tags: ['madness', 'draw'], effects: [{ kind: 'applyStatus', target: SELF, status: 'strength', stacks: 4, duration: 2 }, { kind: 'madnessGain', target: SELF, amount: 8 }, { kind: 'draw', amount: 1 }] },
  ...
  ...mkCards('morgan', 'morgan_gaze', '刽子手凝视', [
    ...
    { rarity: 'green', cost: 1, tags: ['mark'], effects: [{ kind: 'applyStatus', target: EFRONT, status: 'fear', stacks: 2, duration: -1, value: 0.2 }, { kind: 'applyStatus', target: EFRONT, status: 'mark', stacks: 1, duration: -1 }] },
...
const serafinaCards: CardDef[] = [
  ...
  ...mkCards('serafina', 'serafina_healbell', '治愈钟鸣', [
    ...
    { rarity: 'green', cost: 2, tags: ['heal'], effects: [{ kind: 'heal', target: ALLY_LOWEST, amount: [8, 10] }, { kind: 'clearStatus', target: ALLY_LOWEST, stacks: 1 }] },
  ...
  ...mkCards('serafina', 'serafina_hymn', '护佑圣歌', [
    ...
    { rarity: 'green', cost: 2, tags: ['speed'], effects: [{ kind: 'block', target: ALLY_ALL, amount: 6 }, { kind: 'speed', amount: 1 }] },
  ...
  ...mkCards('serafina', 'serafina_atonement', '赎罪之铃', [
    ...
    { rarity: 'green', cost: 2, tags: ['attack', 'soulfire'], effects: [{ kind: 'damage', target: EPOS([4]), amount: [5, 7] }, { kind: 'applyStatus', target: EPOS([4]), status: 'healReduction', stacks: 1, duration: -1, value: 0.75 }, { kind: 'soulfireSteal', amount: 5 }] },
...
const aurisCards: CardDef[] = [
  ...
  ...mkCards('auris', 'auris_darkshot', '暗蚀射击', [
    ...
    { rarity: 'green', cost: 2, tags: ['attack', 'overkill'], effects: [{ kind: 'damage', target: EPOS([3, 4]), amount: [7, 10], overkillMult: 1.5 }] },
  ...
  ...mkCards('auris', 'auris_etch', '蚀刻标记', [
    ...
    { rarity: 'green', cost: 1, tags: ['mark'], effects: [{ kind: 'applyStatus', target: EFRONT, status: 'mark', stacks: 1, duration: 1 }, { kind: 'applyStatus', target: EFRONT, status: 'vulnerable', stacks: 1, duration: 2 }] },
  ...
  ...mkCards('auris', 'auris_forbidden', '禁忌知识', [
    ...
    { rarity: 'green', cost: 1, tags: ['draw', 'madness', 'crit'], effects: [{ kind: 'draw', amount: 2 }, { kind: 'madnessGain', target: SELF, amount: 12 }, { kind: 'critGain', amount: 0.03, critScope: 'battle', duration: -1 }] },
